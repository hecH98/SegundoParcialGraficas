...
{
	// Radio Buttons
	document.getElementById("radio-circle").addEventListener("input", inputRadioCircleEventListener, false);
	document.getElementById("radio-ellipse").addEventListener("input", inputRadioEllipseEventListener, false);
	document.getElementById("radio-cycloid").addEventListener("input", inputRadioCycloidEventListener, false);
	document.getElementById("radio-hypocycloid").addEventListener("input", inputRadioHypoCycloidEventListener, false);
